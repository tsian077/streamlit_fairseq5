...
# def s2t(audio_encod):
#     print(audio_encod)
#     print(len(audio_encod))
    
#     wav_file = open("temp.wav", "wb")
    
#     decode_string = base64.b64decode(audio_encod)
#     print(decode_string)
...
#     wav_file = open("temp.wav","wb")
    ...
    models, _model_args = checkpoint_utils.load_model_ensemble(
        utils.split_paths("/home/jovyan/jimmy/fairseq2/fairseq_cli/english/checkpoint91.pt"),
